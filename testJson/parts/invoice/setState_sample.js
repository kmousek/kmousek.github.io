...
var ccControl = {
    create_contract : async function(){
        try {
            ...
            let rawdata = fs.readFileSync('../../../chaincode/main/go/jsonSample/InvoiceSetStateRequest.json');
            let test_json = JSON.parse(rawdata);

            const result = await contract.submitTransaction('invoiceSetState', JSON.stringify(test_json));
